...
describe("Mask", () => {
  ...
  describe("setup", () => {
    ...
    it("should add a maxlength to the input", () => {
      const mask = getMask();
      expect(input.maxLength).toBe(mask.length);
    });
  });
  ...
  describe("undo and redo", () => {
    it("should handle ordinary typing", () => {
      ...
      const thirdValue = "123456789";
      const maskedThirdValue = "12.345.678/9";
      ...
      const fourthValue = "1235468793210";
      const maskedFourthValue = "12.354.687/9321-0";

      setValue(input, fourthValue);
      ...
      redo(input);
      redo(input);
      expect(input.value).toBe(maskedFourthValue);
    ...
    it("should handle text deletions", () => {
      const firstValue = "43.210.987/6543-21";
    ...
    it("should handle blur", () => {
      const firstValue = "78.945.612/3098-76";

      setValue(input, firstValue);
      blurLeavingPage(input);

      const secondValue = "87.678.945/6123-09";
