...
module.exports = {
  ...
  forbidden: [
    ...
    },
    {
      ...
      severity: "error",
      comment: "Unreachable modules are dead code.",
      from: {
        path: ["^src/index\\.ts$"],
      },
      to: { path: "^src/", pathNot: "__tests__", reachable: false },
    },
    {
      name: "no-spec-out-of-tests",
      comment: "Test should be placed inside __tests__ folders.",
      severity: "error",
      from: {
        path: "[.](?:spec|test)[.](?:js|mjs|cjs|jsx|ts|mts|cts|tsx)$",
        pathNot: "__tests__",
...
// generated: dependency-cruiser@17.4.3 on 2026-06-23T21:06:47.763Z
